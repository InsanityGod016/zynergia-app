  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-card">
        ...
        <p className="legal-updated">Última actualización: 1 de septiembre de 2026</p>
...
function PrivacyContent() {
  return <>
    ...
    <ul>
      ...
      <li><strong>Contenido que proporcionas:</strong> contactos agregados manualmente, teléfonos, notas, etiquetas, tareas, ventas, socios, enlaces de productos, plantillas y recordatorios.</li>
      ...
      <li><strong>Imágenes y códigos QR:</strong> guardamos la foto de perfil si decides subirla y procesamos las imágenes que eliges para crear o compartir un QR.</li>
    </ul>
    ...
    <p>Supabase presta autenticación y base de datos; Vercel aloja el sitio y las funciones del servidor; nuestro proveedor de correo entrega mensajes de cuenta; Stripe procesa el checkout y administra el pago realizado en el sitio web; Apple y Google distribuyen las aplicaciones.</p>
    ...
    <p>Los QR, las imágenes de productos incluidas y las imágenes que eliges se procesan localmente. Sólo salen de la aplicación si decides compartirlos. Al abrir WhatsApp u otro recurso externo que elijas, el contenido necesario y los datos técnicos normales de conexión pueden enviarse a ese proveedor.</p>
    ...
    <p>Los recordatorios móviles actuales son notificaciones locales programadas en tu dispositivo. Puedes rechazarlas o desactivarlas en los ajustes del sistema. No usamos un identificador publicitario para enviarlas.</p>
    ...
    <p>Puedes consultar y corregir datos desde la app o pedir ayuda en el <Link to="/soporte">centro de soporte</Link>. Podemos solicitar información razonable para verificar tu identidad.</p>
...
function TermsContent() {
  return <>
    ...
    <p>Conservas la titularidad de lo que registras. Nos autorizas a alojarlo y procesarlo sólo para operar, proteger y mejorar el servicio. Debes contar con una base legítima para almacenar datos de terceros y respetar sus derechos de privacidad.</p>

    <h2>4. Uso permitido</h2>
    <p>No puedes usar Zynergia para infringir derechos, enviar comunicaciones ilícitas o no solicitadas, introducir código malicioso, intentar acceder a otras cuentas, eludir medidas de seguridad o presentar el servicio como oficial de una empresa ajena.</p>

    <h2>5. Acceso de pago</h2>
    ...
    <h2>6. Eliminación y facturación</h2>
    ...
    <h2>7. Servicios y marcas de terceros</h2>
