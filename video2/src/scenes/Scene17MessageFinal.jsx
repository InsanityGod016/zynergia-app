...
/*
  ...
  LAYOUT: Two lines of text centered on white bg
*/

export const Scene17MessageFinal = () => {
  ...
  // ── Underline draws ──
  const underlineProgress = interpolate(frame, [80, 110], [0, 1], {
    extrapolateLeft: 'clamp',
    extrapolateRight: 'clamp',
  });
  ...
  return (
    <AbsoluteFill style={{backgroundColor: colors.bg}}>
      ...
      >
        ...
        >
          Zynergia te dice cuándo y qué hacer.
        </div>
